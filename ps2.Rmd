...
performance_diff_summary_d = performance_diff_d %>%
  ...
  summarise(MeanImprovementScore = mean(ImprovementScore, na.rm=TRUE), 
            lowerSEM = MeanImprovementScore - (sd(ImprovementScore, na.rm=TRUE)/sqrt(length(ImprovementScore))), 
            upperSEM = MeanImprovementScore + (sd(ImprovementScore, na.rm=TRUE)/sqrt(length(ImprovementScore))))
```
